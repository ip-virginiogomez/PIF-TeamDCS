            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6">
                        <form id="search-form" action="{{ route('unidad-clinicas.index') }}" method="GET">
                            <div class="relative w-full lg:w-1/3">
                                ...
                                <input type="text" 
                                    ...
                                    placeholder="Buscar por Unidad o Centro de Salud..." 
                                    autocomplete="off">
                    ...
                    <div id="tabla-container">
                        @include('unidad-clinicas._tabla', [
                            'unidadesClinicas' => $unidadesClinicas,
                            'sortBy' => $sortBy ?? 'idUnidadClinica',
