                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                @can('centros-formadores.read')<x-dropdown-link :href="route('centros-formadores.index')">{{ __('Centros Formadores') }}</x-dropdown-link>@endcan
                                @can('tipos-centro-formador.read')<x-dropdown-link :href="route('tipos-centro-formador.index')">{{ __('Tipos de Centro') }}</x-dropdown-link>@endcan
                                @can('sede.read')<x-dropdown-link :href="route('sede.index')">{{ __('Sedes') }}</x-dropdown-link>@endcan
                                @can('convenios.read')<x-dropdown-link :href="route('convenios.index')">{{ __('Convenios') }}</x-dropdown-link>@endcan
                            </x-slot>
                        </x-dropdown>
                    </div>
                    @endcanany
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @canany(['centros-formadores.read', 'tipos-centro-formador.read', 'sede.read', 'convenios.read'])
                <div class="border-t border-gray-200 pt-2">
                    ...
                    <x-responsive-nav-link :href="route('centros-formadores.index')" :active="request()->routeIs('centros-formadores.*')" class="pl-6">
                        {{ __('Centros Formadores') }}
                    </x-responsive-nav-link>
                    @endcan
                    @can('tipos-centro-formador.read')
                    <x-responsive-nav-link :href="route('tipos-centro-formador.index')" :active="request()->routeIs('tipos-centro-formador.*')" class="pl-6">
                        {{ __('Tipos de Centro') }}
                    </x-responsive-nav-link>
                    @endcan
                    @can('sede.read')
                    <x-responsive-nav-link :href="route('sede.index')" :active="request()->routeIs('sede.*')" class="pl-6">
                        {{ __('Sedes') }}
                    </x-responsive-nav-link>
                    @endcan
                    @can('convenios.read')
                    <x-responsive-nav-link :href="route('convenios.index')" :active="request()->routeIs('convenios.*')" class="pl-6">
                        {{ __('Convenios') }}
                    </x-responsive-nav-link>
                    @endcan
                </div>
            ...
            <div class="border-t border-gray-200 pt-2">
                ...
                <x-responsive-nav-link :href="route('unidad-clinicas.index')" :active="request()->routeIs('unidad-clinicas.*')" class="pl-6">
            ...
            @canany(['periodos.read', 'cupo-ofertas.read', 'tipos-practica.read'])
                <div class="border-t border-gray-200 pt-2">
                    ...
                    @can('periodos.read')
                    <x-responsive-nav-link :href="route('periodos.index')" :active="request()->routeIs('periodos.*')" class="pl-6">
                        {{ __('Períodos') }}
                    </x-responsive-nav-link>
                    @endcan
                    @can('cupo-ofertas.read')
                    <x-responsive-nav-link :href="route('cupo-ofertas.index')" :active="request()->routeIs('cupo-ofertas.*')" class="pl-6">
                        {{ __('Oferta de Cupos') }}
                    </x-responsive-nav-link>
                    @endcan
                    @can('tipos-practica.read')
                    <x-responsive-nav-link :href="route('tipos-practica.index')" :active="request()->routeIs('tipos-practica.*')" class="pl-6">
