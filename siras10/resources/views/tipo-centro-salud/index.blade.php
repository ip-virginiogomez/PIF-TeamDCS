<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-black leading-tight">
                {{ __('Gestión de Tipos de Centro de Salud') }}
            </h2>
            <button 
                data-modal-target="tipoCentroSaludModal" 
                data-modal-toggle="tipoCentroSaludModal" 
    ...
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div id="tabla-container">
                        @include('tipo-centro-salud._tabla', [
                            'tipos' => $tipos,
                            'sortBy' => $sortBy,
        ...
        title="Gestión de Tipo de Centro de Salud"
        primaryKey="idTipoCentroSalud">
        
        {{-- Nombre del Tipo --}}
        <div class="mb-4">
            <label for="nombreTipo" class="block text-sm font-medium text-gray-700">Nombre del Tipo *</label>
            <input type="text" id="nombreTipo" name="nombreTipo" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="Ej: Centro de Salud Familiar" required>
            <div class="text-red-500 text-sm mt-1 hidden" id="error-nombreTipo"></div>
        </div>
