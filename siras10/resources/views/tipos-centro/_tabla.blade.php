            ...
            <tr class="border-b" id="tipos-{{ $tipos->idTipoCentroFormador }}">
                <td class="py-2 px-4">
                    <div class="flex items-center space-x-3">
                        <div>
                            <span class="font-medium">{{ $tipos->idTipoCentroFormador }}</span>
                        </div>
                    </div>
                </td>
                <td class="py-2 px-4">
                    <div class="flex items-center space-x-3">
                        <div>
                            <span class="font-medium">{{ $tipos->nombreTipo }}</span>
                        </div>
                    </div>
                </td>
                <td class="py-2 px-4">
                ...
                <td class="py-2 px-4 flex space-x-2">
                    <button data-action="edit" data-id="{{ $tipos->idTipoCentroFormador }}" class="text-yellow-500 hover:text-yellow-700">
                        <i class="fas fa-edit"></i> Editar
                    </button>
                    <button data-action="delete" data-id="{{ $tipos->idTipoCentroFormador }}" class="text-red-500 hover:text-red-700">
