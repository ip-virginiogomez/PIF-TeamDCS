            ...
            <tr>
                @php
                    $getSortLink = function($column, $text) use ($sortBy, $sortDirection) {
                        ...
                        $url = route('alumnos.index', $params);
                ...
                @endphp
                <th class="py-2 px-4 text-left whitespace-nowrap"> {!! $getSortLink('runAlumno', 'RUN') !!}</th>
                <th class="py-2 px-4 text-left whitespace-nowrap">Foto</th>
                <th class="py-2 px-4 text-left whitespace-nowrap"> {!! $getSortLink('nombres', 'Nombres') !!}</th>
